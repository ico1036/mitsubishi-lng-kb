...
ingest2: 미쓰비시상사-Equity-Research.html + reports/(발표 PDF 3종, 2026.06.16) → +4 findings / +1 source / +valuation_2026.csv / +온톨로지(2노드·5관계)
---
...
## 🧬 온톨로지 & 📦 데이터 레이어
- [[ONTOLOGY-관계지도]] — 35노드·46관계 지식그래프 (HTML 임베디드 그래프 추출 + 감사 보강 + 2026 밸류에이션/시장 ingest). 첫 병합에서 통째로 누락됐던 구조.
- **숫자 데이터(`_data/*.csv`)**: `financials_net_income`(순이익 시계열) · `ee_segment` · `lng_shale_assets_fy2025` · `valuation_2026`(밸류에이션·DCF 🆕) · `key_metrics`(63행) · `ontology_nodes`/`ontology_edges` · `sources`(35개 소스 원장).
...
- [[S-Equity-Research-2026]] (secondary, 자체 분석 — 밸류에이션·발표자료)
### 기존 (deep-research 검증)
